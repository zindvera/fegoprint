    ...
    const scrollNavHTML = `
      <div class="scroll-nav" style="width: 100vw; position: fixed; top: 0; left: 0; background: white; z-index: 1000; padding: 0.5rem 1rem; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
        <div class="d-flex align-items-center">
          <a href="${relativePrefix}fegoprint/index.html" style="text-decoration: none;">
            <img id="logo" src="${relativePrefix}fegoprint/media/logo/fegoprint.png" alt="Logo" style="height: 35px; margin-right: 10px;">
          </a>
